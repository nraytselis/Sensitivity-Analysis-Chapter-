...
pars <- c( "ImmigrationPeriod", "ImmigrationRate", "FishingRate","L1day") # Choose parameters of interest
...
parameters["ImmigrationPeriod"] = ImmigrationPeriod; parameters["ImmigrationRate"] = ImmigrationRate; parameters["FishingRate"] = FishingRate; parameters["L1day"] = L1day;
...
sobol_fxn(ImmigrationPeriod = parameters["ImmigrationPeriod"],ImmigrationRate = parameters["ImmigrationRate"], FishingRate = parameters["FishingRate"], L1day = parameters["L1day"])
...
toplot.L3F <- subset(indL3F$results, parameters=="ImmigrationPeriod" | parameters=="ImmigrationRate" | parameters=="FishingRate"| parameters=="L1day")
toplot.I <- subset(indI$results, parameters=="ImmigrationPeriod" | parameters=="ImmigrationRate" | parameters=="FishingRate"| parameters=="L1day")
toplot.HEF <- subset(indHEF$results, parameters=="ImmigrationPeriod" | parameters=="ImmigrationRate" | parameters=="FishingRate"| parameters=="L1day")
toplot.Preds <- subset(indPreds$results, parameters=="ImmigrationPeriod" | parameters=="ImmigrationRate" | parameters=="FishingRate" | parameters=="L1day")
...
make_sobol_plot <- function(ind_obj, title_text = NULL) {
  ...
  ggplot(df_plot, aes(param, value, fill = sensitivity)) +
    geom_col(color = "white", linewidth = 0.3) +
    geom_text(
      aes(label = ifelse(sensitivity %in% c("Si", "Ti"), "", parameters)),
      position = position_stack(vjust = 0.5),
...
p_I     <- make_sobol_plot(indI,    "I")
p_HEF   <- make_sobol_plot(indHEF,  "HEF")
